...
import termsPage from "assets/jss/material-kit-react/views/termsPage.jsx";
  ...
  render() {
    ...
    return (
      <div className={classes.container}>
        ...
        />
        <p>
          제1조(목적) 이 약관은 주식회사 보노웨어가 운영하는 사이버 몰
          “프로브”(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
        ...
        <p>
          ① “몰”이란 주식회사 보노웨어가 재화 또는 용역(이하 “재화 등”이라 함)을
        ...
        <p>
          "몰"은 "몰"이용자의 자가 사용의 목적으로 구매하여 수입하는 경우에만
          서비스를 제공하며, 한편 아래의 경우 고객의 동의를 구한 후 한국으로
          발송하거나 해당 발송자에 게로 반송할 수 있으며 "몰"이용자의 귀책
          사유로 인해 회원의 소재가 불명확한 경우 "몰"은 당해 물품을 발송인에게
          반송하고 이를 회원에게 통보하며, 소요비용은 "몰"이용자로부터
          정산하거나 "몰"의 임의대로 물품을 처리하여 충당할 수 있습니다.
        </p>
        <p>가.</p>
        <p>
          관세법 제234조(수출입의 금지) 다음 각호의 1에 해당하는 물품은 수출
          또는 수입할 수 없다.
        </p>
        <p>
          1) 헌법질서를 문란하게 하거나 공공의 안녕질서 또는 풍속을
          해치는서적•간행물•도화•영화•음반• 비디오물•조각물 기타 이에 준하는
          물품
        </p>

        <p>2) 정부의 기밀을 누설하거나 첩보활동에 사용되는 물품</p>

        <p>3) 화폐•채권 기타 유가증권의 위조품•변조품 또는 모조품</p>
        <p>① 목록통관 배제대상물품 </p>
        <p>- 의약 </p>
        <p>- 한약재 </p>
        <p>- 야생동물 관련상품 </p>
        <p>- 농림축수산물등 검역대상물품 </p>
        <p>- 건강기능식품 </p>
        <p>- 지적재산권 위반 의심물품식품류 </p>
        <p>- 식품류, 과자류 </p>
        <p>
          - 화장품(기능성화장품, 태반함유화장품, 스테로이드제 함유화장품,
          성분미상유해화장품){" "}
        </p>
        <p>
          - 전자상거래 물품 등의 특별한 통관절차에 관한 고시 제3-3조 제3항에
          따라 특별통관대상업체로 지정되지 아니한 전자상거래업체가 수입하는 물품{" "}
        </p>
        <p>- 통관목록 중 품명, 규격, 수량, 가격 등이 부정확하게 기재된 물품 </p>
        <p>
          - 그 밖에 법 제226조에 따른 세관장확인대상물품 등 목록통관이 타당하지
          하니하다고 세관장이 인정하는 물품{" "}
        </p>

        <p>
          4) 동물, 금,은괴, 화폐, 무기류, 인체의 일부, 정밀금속,
          석재류,냉장보관물품,냉장보관물품,냉동 또는 냉장을 요하는 물품 및
          폭발물, 가연성 위험물 등
        </p>

        <p>5) 수입, 수출 불가 / 항공운송 불가 품목일 경우</p>

        <p>
          6) 송장(Invoice) 부실기재, 포장불량 등으로 본 약관에 따른 서비스를
          제공하기에 적절하지 않다고 "몰"이 판단하는 경우
        </p>
        ...
        <p>
          제12조(지급방법) “몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은
        ...
        <p>
          제15조(환급) “몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로
        ...
        <p>
          ① "몰"이용자는 위법, 불법 또는 부당한 목적을 위해 서비스를 이용한다고
          "몰"이 판단하는 때에는 "몰"은 관련 물품의 수취나 배송을 거절할 권리를
          가집니다.
        </p>

        <p>
          ② 관할관청 또는 당국에 의해 "몰"에 의해 서비스되는 물품에 대해 제재를
          받았을 때 "몰"은 해당물품을 관할관청 또는 당국에 인도하는 것을
          원칙으로 합니다. 이로 인하여 "몰"이용자가 손해를 입었다고 할지라도
          해당 손해에 대해서 "몰"은 일체의 책임을 지지 않으며 또한 "몰"이용자는
          해당 물품에 대한 서비스 이용요금 및 관련비용 등 의 지급의무를 면하지
          아니합니다.
        </p>

        <p>
          ③ "몰" 주소로 배송된 물품에 악취, 액체누수 그 외 이상이 있다고
          인정됐을 경우 및 기타 긴급을 필요로 하고 정당한 이유가 있다고 인정이
          됐을 경우 "몰"은 "몰"이용자에게 해당사실을 통지하고 해당물품을 별도
          장소로 이동 보관하는 등 임시조치를 취할 수 있습니다. 이로 인해
          발생하는 추가비용은 "몰"이용자가 부담하여야 하며 또한 "몰"이용자에게
          손해가 발생하더라도 해당 손해에 대하여 "몰"은 일체의 책임을 지지
          않습니다.
        </p>
        ...
        <p>제22조(이용자의 의무) 이용자는 다음 행위를 하여서는 안 됩니다.</p>
...
export default withStyles(termsPage)(TermsPage);
