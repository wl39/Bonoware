    ...
    db.scan(params2, (err, data) => {
        if (err) console.log(err);
            ...
            for (let x = 0; x < data.Items.length; x++) {
                ...
                if (x === 0 || data.Items[x].LowestPrice === 0) {
                    ...
                    for (let z = x; z > 0; z--) {
                        if (arrayOfShoeObjects[z - 1].LowestPrice === 0 || arrayOfShoeObjects[z - 1].LowestPrice >= data.Items[x].LowestPrice) {
                            k = z - 1;
                        }
                    }
            ...
            for (let x = 0; x < 10; x++) {
                ...
                db.put(params999, (err, data) => {
                    ...
                    else context.done(null, "Successfully Updated");
                })
            }
